...
function Basketfooter() {
    ...
    <div className="web-footer">
        ...
        <div className="footer-signoff">
            ...
            <p><a href="#footerIcons"><img className="footericons" src="https://cdn-icons-png.flaticon.com/512/106/106852.png" alt="copywriteicon" />2022 BARDSTORE</a></p>
        </div>
        <hr />
        <div className='basket-footer'>
                <div id="addedtobasketnotification">
            ...
            <a href="/basket">
               ...
               <img id="shopping-basket" src="https://cdn-icons-png.flaticon.com/512/2636/2636890.png" alt="basket-icon" />
                <span className="cartcomponent">CART</span><span className="basketnumber">{cartItems.length}</span>
                </button>
            </a>
        </div>
    </div>
